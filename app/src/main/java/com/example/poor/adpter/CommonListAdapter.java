...
public class CommonListAdapter extends BaseAdapter {
    Context context;
    int image1[]={R.drawable.poor4,R.drawable.poor2};
    ...
    public CommonListAdapter(Context context1) {
        context=context1;
    }
    @Override
    public int getCount() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        //关联item
        View view = LayoutInflater.from(context).inflate(R.layout.k_common_item,parent,false);
        //关联id
        ImageView imageView1 =(ImageView)view.findViewById(R.id.image1_common);
        ImageView imageView2 = (ImageView)view.findViewById(R.id.image2_common);
        TextView textView = (TextView)view.findViewById(R.id.text2_common);
